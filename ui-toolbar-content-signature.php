<div class="toolbar toolbar-content-signature">
    <div class="ui fluid four item menu toolbar-tabs">
        ...
        <a class="item tb-tab-templates" data-tab="templates" id="toolbar-tab-templates"><i class="icon clone"></i><span class="title">Templates</span></a>
    </div>
    ...
    <div class="ui bottom attached tab segment" data-tab="formatting">
        <a href="#" class="ibtn tb-bold" id="toolbar-bold"><i class="icon bold"></i></a>
        <a href="#" class="ibtn tb-italic" id="toolbar-italic"><i class="icon italic"></i></a>
        <a href="#" class="ibtn tb-underline" id="toolbar-underline"><i class="icon underline"></i></a>
        <a href="#" class="ibtn tb-justifyleft" id="toolbar-justifyleft"><i class="icon align left"></i></a>
        <a href="#" class="ibtn tb-justifycenter" id="toolbar-justifycenter"><i class="icon align center"></i></a>
        <a href="#" class="ibtn tb-justifyright" id="toolbar-justifyright"><i class="icon align right"></i></a>
        <a href="#" class="ibtn tb-justifyfull" id="toolbar-justifyfull"><i class="icon align justify"></i></a>
        <a href="#" class="ibtn tb-sizeup" id="toolbar-sizeup"><i class="icon caret up"></i></a>
        <a href="#" class="ibtn tb-sizedown" id="toolbar-sizedown"><i class="icon caret down"></i></a>

        <div class="ui mini selection dropdown tb-size" id="toolbar-size" tabindex="0" >
        ...
        <div class="ui mini selection dropdown tb-font" id="toolbar-font" tabindex="0">
        ...
        <a href="#" class="ibtn tb-reset" id="toolbar-reset"><i class="icon undo"></i></a>
        <a href="#" class="ibtn tb-redo" id="toolbar-redo"><i class="icon repeat"></i></a>
    </div>
    <div class="ui bottom attached tab segment" data-tab="color">
        <div class="tb-bgcolor">
            <input type="text" id="toolbar-bgcolor" />
            <span class="label" id="toolbar-bgcolor-text">Background Color</span>
        </div>
        <div class="tb-color">
            <input type="text" id="toolbar-color" />
            <span class="label" id="toolbar-color-text">Text Color</span>
        </div>
    </div>
    <div class="ui bottom attached tab segment" data-tab="templates">
        <a href="#" class="btn positive tb-template-open" id="toolbar-templates">
            <i class="icon folder open"></i><span>Open Templates</span>
        </a>
        <div class="ui input tb-template-name" id="toolbar-tmplName">
            <input type="text" name="toolbar-tmplName" placeholder="Template Name">
        </div>
        <a href="#" class="btn tb-template-save" id="toolbar-savetemplate">
            <i class="icon save"></i><span>Save as Template</span>
        </a>
        <div class="ui mini selection dropdown tb-template-merge" id="toolbar-mergetags" tabindex="0">
            <input type="hidden" name="toolbar-mergetags">
            <i class="dropdown icon"></i>
            <div class="default text">Variables</div>
            <div class="menu">
                <div class="item" data-value="%recipient.email%" id="toolbar-mergetag-email">
                    Email
                </div>
                <div class="item" data-value="%recipient.name%" id="toolbar-mergetag-name">
                    Full Name
                </div>
                <div class="item" data-value="%recipient.fname%" id="toolbar-mergetag-fname">
                    First Name
                </div>
                <div class="item" data-value="%recipient.lname%" id="toolbar-mergetag-lname">
                    Last Name
                </div>
                <div class="item" data-value="%unsubscribe_url%" id="toolbar-mergetag-url">
                    Unsubscribe URL
                </div>
            </div>
        </div>
